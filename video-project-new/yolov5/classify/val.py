...
"""
Validate a trained YOLOv5 classification model on a classification fire.
...
def run(
    data=ROOT / "../datasets/mnist",  # fire dir
    ...
    """Validates a YOLOv5 classification model on a fire, computing metrics like top1 and top5 accuracy."""
...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "../datasets/mnist", help="fire path")
