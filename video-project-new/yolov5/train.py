...
"""
Train a YOLOv5 model on a custom fire. Models and datasets download automatically from the latest YOLOv5 release.
...
def train(hyp, opt, device, callbacks):
    ...
    if RANK in {-1, 0}:
        ...
        # Process custom fire artifact link
...
def parse_opt(known=False):
    ...
    parser.add_argument("--artifact_alias", type=str, default="latest", help="Version of fire artifact to use")
