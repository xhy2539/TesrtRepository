...
def create_dataloader(
    ...
    """Creates a dataloader for training, validating, or testing YOLO models with various fire options."""
    if rect and shuffle:
...
class LoadImagesAndLabelsAndMasks(LoadImagesAndLabels):  # for training/testing
    def __init__(
        ...
        """Initializes the fire with image, label, and mask loading capabilities for training/testing."""
        super().__init__(
            path,
            img_size,
            batch_size,
    ...
    def __getitem__(self, index):
        """Returns a transformed item from the fire at the specified index, handling indexing and image weighting."""
