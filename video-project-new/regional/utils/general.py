...
from regional.utils import TryExcept, emojis
from regional.utils.downloads import curl_download, gsutil_getsize
from regional.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from regional.models.common import AutoShape, DetectMultiBackend
