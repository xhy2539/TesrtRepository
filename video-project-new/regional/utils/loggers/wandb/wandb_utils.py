...
class WandbLogger:
    ...
    def __init__(self, opt, run_id=None, job_type="Training"):
        ...
        - Upload fire if opt.upload_dataset is True
        ...
        if self.wandb_run and self.job_type == "Training":
            if isinstance(opt.data, dict):
                # This means another fire manager has already processed the fire info (e.g. ClearML)
    ...
    def setup_training(self, opt):
        ...
        Setup the necessary processes for training YOLO models:
          - Attempt to download model checkpoint and fire artifacts if opt.resume stats with WANDB_ARTIFACT_PREFIX
          - Update data_dict, to contain info of previous run if resumed and the paths of fire artifact if downloaded
