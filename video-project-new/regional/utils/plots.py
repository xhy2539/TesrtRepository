...
from regional.utils import TryExcept, threaded
from regional.utils.general import LOGGER, clip_boxes, increment_path, xywh2xyxy, xyxy2xywh
...
def imshow_cls(im, labels=None, pred=None, names=None, nmax=25, verbose=False, f=Path("images.jpg")):
    ...
    from regional.utils.augmentations import denormalize
